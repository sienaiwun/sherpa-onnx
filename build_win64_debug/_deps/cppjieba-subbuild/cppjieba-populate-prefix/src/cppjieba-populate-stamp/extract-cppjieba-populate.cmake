...
#
get_filename_component(filename "D:/Sound/sienaiwun/sherpa-onnx/build_win64_debug/_deps/cppjieba-subbuild/cppjieba-populate-prefix/src/sherpa-onnx-2024-04-19.tar.gz" ABSOLUTE)
get_filename_component(directory "D:/Sound/sienaiwun/sherpa-onnx/build_win64_debug/_deps/cppjieba-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-cppjieba-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-cppjieba-populate${i}")
