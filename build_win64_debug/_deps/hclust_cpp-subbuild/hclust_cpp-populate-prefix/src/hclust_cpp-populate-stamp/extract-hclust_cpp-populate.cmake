...
#
get_filename_component(filename "D:/Sound/sienaiwun/sherpa-onnx/build_win64_debug/_deps/hclust_cpp-subbuild/hclust_cpp-populate-prefix/src/2024-09-29.tar.gz" ABSOLUTE)
get_filename_component(directory "D:/Sound/sienaiwun/sherpa-onnx/build_win64_debug/_deps/hclust_cpp-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-hclust_cpp-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-hclust_cpp-populate${i}")
