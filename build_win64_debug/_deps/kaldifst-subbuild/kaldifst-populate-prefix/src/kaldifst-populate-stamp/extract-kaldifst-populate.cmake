...
#
get_filename_component(filename "D:/Sound/sienaiwun/sherpa-onnx/build_win64_debug/_deps/kaldifst-subbuild/kaldifst-populate-prefix/src/v1.7.17.tar.gz" ABSOLUTE)
get_filename_component(directory "D:/Sound/sienaiwun/sherpa-onnx/build_win64_debug/_deps/kaldifst-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-kaldifst-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-kaldifst-populate${i}")
