...
#
get_filename_component(filename "D:/Sound/sienaiwun/sherpa-onnx/build_win64_debug/_deps/cargs-subbuild/cargs-populate-prefix/src/v1.0.3.tar.gz" ABSOLUTE)
get_filename_component(directory "D:/Sound/sienaiwun/sherpa-onnx/build_win64_debug/_deps/cargs-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-cargs-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-cargs-populate${i}")
