...
#
get_filename_component(filename "D:/Sound/sienaiwun/sherpa-onnx/build_win64_debug/_deps/cppinyin-subbuild/cppinyin-populate-prefix/src/v0.10.tar.gz" ABSOLUTE)
get_filename_component(directory "D:/Sound/sienaiwun/sherpa-onnx/build_win64_debug/_deps/cppinyin-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-cppinyin-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-cppinyin-populate${i}")
