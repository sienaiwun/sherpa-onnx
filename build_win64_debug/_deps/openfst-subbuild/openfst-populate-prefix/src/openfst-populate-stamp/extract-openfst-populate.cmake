...
#
get_filename_component(filename "D:/Sound/sienaiwun/sherpa-onnx/build_win64_debug/_deps/openfst-subbuild/openfst-populate-prefix/src/sherpa-onnx-2024-06-19.tar.gz" ABSOLUTE)
get_filename_component(directory "D:/Sound/sienaiwun/sherpa-onnx/build_win64_debug/_deps/openfst-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-openfst-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-openfst-populate${i}")
